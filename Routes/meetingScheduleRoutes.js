...
import { Create, GetAllMeetingSchedules, GetMyMeetings, GetMyTodaysMeetings, GetMyTomorrowsMeetings, GetAllNotPublishedMeetingSchedules, GetMeetingScheduleById, GetMeetingById, Edit, DeleteById, MarkMeetingDoneBySales, MarkMeetingDoneByExecutive } from '../Controllers/MeetingScheduleController.js'
...
// Specific routes must come before the catch-all route (:id)
...
MeetingScheduleRouter.put('/mark-done-sales/:id', RoleAuthMiddleware("admin", "sales"), MarkMeetingDoneBySales)//sales can mark meeting as done
MeetingScheduleRouter.put('/mark-done-executive/:id', RoleAuthMiddleware("admin", "executive"), MarkMeetingDoneByExecutive)//executive can mark meeting as done
